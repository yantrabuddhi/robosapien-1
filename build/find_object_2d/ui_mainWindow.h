...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 222, 409));
        ...
        gridLayout->addWidget(label_minMatchedDistance, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(label_maxMatchedDistance, 10, 1, 1, 1);
        ...
        gridLayout->addWidget(label_timeExtraction, 3, 1, 1, 1);
        ...
        gridLayout->addWidget(label_vocabularySize, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(label_ipAddress, 12, 1, 1, 1);

        label_port = new QLabel(dockWidgetContents_4);
        label_port->setObjectName(QString::fromUtf8("label_port"));

        gridLayout->addWidget(label_port, 13, 1, 1, 1);
        ...
        gridLayout->addWidget(label_objectsDetected, 8, 1, 1, 1);
        ...
        gridLayout->addWidget(label_timeHomographies, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(label_port_image, 14, 1, 1, 1);
        ...
        gridLayout->addWidget(label_timeSkewAffine, 2, 1, 1, 1);
        ...
        gridLayout->addWidget(label_24, 7, 0, 1, 1);
        ...
        gridLayout->addWidget(label_timeRefreshGUI, 7, 1, 1, 1);

        label_25 = new QLabel(dockWidgetContents_4);
        label_25->setObjectName(QString::fromUtf8("label_25"));

        gridLayout->addWidget(label_25, 7, 2, 1, 1);
