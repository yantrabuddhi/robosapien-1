...
class Target(genpy.Message):
  _md5sum = "e979efe430ffe5ed7edc21b98ae753b2"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4if.pack(_x.bb.x, _x.bb.y, _x.bb.width, _x.bb.height, _x.bb.confidence))
      _x = self.bb.tracker_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bb.x, _x.bb.y, _x.bb.width, _x.bb.height, _x.bb.confidence,) = _struct_4if.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.bb.tracker_id = str[start:end].decode('utf-8')
      else:
        self.bb.tracker_id = str[start:end]
      _x = self
      start = end
      end += 12
