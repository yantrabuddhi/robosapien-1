...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/abeni/rob/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/abeni/rob/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/abeni/rob/install)
...
if(NOT "/home/abeni/rob/src/cv_camera/include " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/abeni/rob/src/cv_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abeni/rob/src/cv_camera/${idir}'.  Ask the maintainer 'Takashi Ogura <t.ogura@gmail.com>' to fix it.")
    endif()
