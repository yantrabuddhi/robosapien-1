...
(cl:defmethod cl:initialize-instance :after ((m <compass>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'compass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-msg:<compass> is deprecated: use robot-msg:compass instead.")))
...
(cl:defmethod heading_deg-val ((m <compass>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-msg:heading_deg-val is deprecated.  Use robot-msg:heading_deg instead.")
  (heading_deg m))
