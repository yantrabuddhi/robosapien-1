...
if("TRUE" STREQUAL "TRUE")
  set(launcher_SOURCE_PREFIX /home/abeni/rob/src/launcher)
  set(launcher_DEVEL_PREFIX /home/abeni/rob/devel)
  set(launcher_INSTALL_PREFIX "")
  set(launcher_PREFIX ${launcher_DEVEL_PREFIX})
else()
  set(launcher_SOURCE_PREFIX "")
  set(launcher_DEVEL_PREFIX "")
  set(launcher_INSTALL_PREFIX /home/abeni/rob/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mandeep <mandeep@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abeni/rob/src/launcher/${idir}'.  Ask the maintainer 'mandeep <mandeep@todo.todo>' to fix it.")
    endif()
